...
const mapStateToProps = state => {
	return {
	  ...
	  selectedSlider:state.updateWidget.present.selectedSlider,
	  photos: state.updateWidget.present.photos,
	  previewSlideColor: state.updateWidget.present.previewSlideColor,
	  isCarouselSaved: state.updateWidget.present.isCarouselSaved,
	  generatedLink: state.updateWidget.present.generatedLink,
	}
  }
